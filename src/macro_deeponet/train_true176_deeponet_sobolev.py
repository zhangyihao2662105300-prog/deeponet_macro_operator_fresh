...
def write_loss_history(out_dir: Path, history: list[dict[str, Any]]) -> None:
    ...
    keys = [
        ...
        "point_b_correction_norm_ratio", "point_b_correction_rms", "global_b_prior_rms",
        "b_prior_current_train_rel", "b_prior_current_train_cos",
        "b_prior_current_train_norm_rel", "b_prior_current_train_norm_cos",
        "b_prior_current_train_evalcols_norm_rel", "b_prior_current_train_evalcols_norm_cos",
        "b_prior_current_train_B_rel", "b_prior_current_train_B_cos",
        "b_prior_current_train_evalcols_B_rel", "b_prior_current_train_evalcols_B_cos",
        "b_prior_current_val_rel", "b_prior_current_val_cos",
        "b_prior_current_val_norm_rel", "b_prior_current_val_norm_cos",
        "b_prior_current_val_evalcols_norm_rel", "b_prior_current_val_evalcols_norm_cos",
        "b_prior_current_val_B_rel", "b_prior_current_val_B_cos",
        "b_prior_current_val_evalcols_B_rel", "b_prior_current_val_evalcols_B_cos",
